...
-- Dieu phoi vien: duoc xem/cap nhat du lieu dieu phoi; VPD van giu lop bao ve neu role bi dung sai.
GRANT SELECT, INSERT, UPDATE, DELETE ON NHANVIEN TO RL_DIEUPHOI;
GRANT SELECT, INSERT, UPDATE, DELETE ON BENHNHAN TO RL_DIEUPHOI;
GRANT SELECT, INSERT, UPDATE, DELETE ON HSBA TO RL_DIEUPHOI;
GRANT SELECT, INSERT, UPDATE, DELETE ON HSBA_DV TO RL_DIEUPHOI;
GRANT SELECT, INSERT, UPDATE, DELETE ON DONTHUOC TO RL_DIEUPHOI;
...
GRANT UPDATE(LIEUDUNG) ON DONTHUOC TO RL_BACSI;
GRANT SELECT ON HSBA_DV TO RL_BACSI;
GRANT INSERT(MAHSBA, LOAIDV, NGAYDV, MAKTV, KETQUA) ON HSBA_DV TO RL_BACSI;
...
GRANT UPDATE(LIEUDUNG) ON VW_BACSI_DONTHUOC TO RL_BACSI;
GRANT SELECT, INSERT, DELETE ON VW_BACSI_HSBA_DV TO RL_BACSI;
